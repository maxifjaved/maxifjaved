...
seo:
  ...
  description: "Browser-based, zero-install wireless screen casting to TouchIT interactive LED displays, built with React and OpenVidu WebRTC, with multi-presenter sessions."
