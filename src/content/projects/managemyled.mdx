...
seo:
  ...
  description: "Built the web portal for ManageMyLED, an MDM and remote-control platform for TouchIT interactive displays, with Agora/OpenVidu remote screen control."
