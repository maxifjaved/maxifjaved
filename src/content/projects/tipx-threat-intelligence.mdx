...
images:
  ...
  thumbnail:
    ...
    height: 300
  gallery:
    - src: "/img/projects/tipx-globe.jpg"
      alt: "World Globe threat visualization"
      width: 800
      height: 600
    - src: "/img/projects/tipx-dashboard.jpg"
      alt: "Unified threat intelligence dashboard"
      width: 800
      height: 600
    - src: "/img/projects/tipx-integration.jpg"
      alt: "MISP and OpenCTI integration"
      width: 800
      height: 600

seo:
  title: "TIPX: Custom Threat Intelligence Platform | Muhammad Asif Javed"
  description: "Built enterprise threat intelligence platform integrating MISP and OpenCTI with custom APIs, World Globe visualization, and white-label UI for cybersecurity operations."
